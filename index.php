...
?>
	  ...
	  <button onclick='moveFunction("left")' type='button' style='width:100px'>left</button>
	  <button onclick='moveFunction("go")' type='button' style='width:100px'>go</button>
	  <button onclick='moveFunction("right")' type='button' style='width:100px'>right</button><br>
	  
	 
	  <button onclick='moveFunction("gofast")' type='button'style='width:100px'>faster</button>
	   <button onclick='moveFunction("rev")' type='button'style='width:100px'>reverse</button>
	  <button onclick='moveFunction("gofastest")' type='button'style='width:100px'>fastest</button><br>
	  <button onclick='moveFunction("kill")' type='button' style='width:100px'>DIE!</button>
         <?php pan_controls(); ?>
         <?php user_buttons(); ?>
