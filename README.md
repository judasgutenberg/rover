...
I added an L298N dual H-bridge controlling a reversible drive motor and another motor that drives a rack & pinion steering rig. The drive motor is controlled by Raspbery Pi GPIO pin #18 and pins #20 and #21. The steering is controlled by GPIO pins #24, #19, and #16. The rover I has makes it possible to determine where the wheels are pointed electronically, and I hope to be able to take that into account soon.
